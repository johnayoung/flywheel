...
fw-verify proves an oracle exists at authoring time; the execute-time held-out gate documented here is the complementary orchestrator half that grades the real run. See [workflow.md](workflow.md) for the full define/task/execute/audit pipeline.
