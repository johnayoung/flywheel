...
(``flywheel_core.audit.stream``) and at the persistence seam (write-time, a
...
Purity discipline (mirrors :mod:`flywheel_core.task` / :mod:`flywheel_core.lifecycle`):
...
from flywheel_core.store_protocols import AuditRecord, SdkMessageRecord
