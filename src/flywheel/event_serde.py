...
:mod:`flywheel.events` is pure — it knows nothing about how an event is
...
Keeping this out of :mod:`flywheel.events` preserves that module's purity
...
from flywheel.lifecycle import Outcome, Status
