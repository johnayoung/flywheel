...
* ``invoke`` — the default :func:`flywheel.invoker.invoke_iteration`, which
...
* ``store`` — :class:`flywheel.store_sqlite.SqliteStore`, a real persistence
...
from flywheel.invoker import invoke_iteration
...
def make_claude_code_invoke(
    ...
    *,
    ...
    transport :func:`flywheel.invoker.invoke_iteration` wraps) and passes
